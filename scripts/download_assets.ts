...
export const imageAssets: Record<string, ImageAsset[]> = {
  'https://img.souhait.me/Souhait4_icon.png': [
    { filename: '/favicon.ico', width: 32, height: 32 },
    ...
    { filename: '/open-graph.png', width: 384, height: 384 },
  ],
  ...
  'https://img.souhait.me/Souhait4_top.png': [
    { filename: '/images/souhait-chan/top.webp', width: 690, height: 960 },
  ],
  'https://img.souhait.me/art/sakananoonigiri1.png': [
    { filename: '/images/souhait-chan/fan-arts/sakananoonigiri1.webp' },
  ],
};
